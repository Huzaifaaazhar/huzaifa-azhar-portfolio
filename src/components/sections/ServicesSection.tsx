...
export function ServicesSection() {
  return (
    <section
      id="services"
      className="rounded-t-[40px] border-t border-[#1A2A28] bg-[#101B1A] px-5 py-20 sm:rounded-t-[50px] sm:px-8 sm:py-24 md:rounded-t-[60px] md:px-10 md:py-32"
    >
      <h2
        className="hero-heading mb-16 text-center leading-none sm:mb-20 md:mb-28"
          ...
          <FadeIn key={service.number} delay={i * 0.1}>
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <p
                  className="max-w-2xl font-light leading-relaxed text-[#7B928D]"
